...
namespace FP
{
    ...
    public static class DataSourceExtensions
    {
        public static IEnumerable<string[]> ReadRecords(this DataSource data) 
            => Enumeration.RepeatUntilNull(data.NextRecord);
    ...
    public static class Enumeration
    {
        ...
        public static IEnumerable<T> AfterEvery<T>(this IEnumerable<T> items, int period, Action<int> afterNth)
        {
            var n = 0;
